window.addEventListener('load', function() {
  ...
  const advectionShader = compileShader(gl.FRAGMENT_SHADER, `
      ...
      #endif
          float decay = 1.02 + dissipation * dt;
  ...
  const curlShader = compileShader(gl.FRAGMENT_SHADER, `
      ...
      void main () {
          ...
          gl_FragColor = vec4(0.25 * vorticity, 0.0, 0.0, 1.0);
      }
  `);
...
//   }
  ...
  function HSVtoRGB (h, s, v) {
      ...
      switch (i % 3) {
          case 0: r = 160, g = 95, b = 25; break;
          case 1: r = 254, g = 212, b = 243; break;
          case 2: r = 255, g = 239, b = 219; break;
      }
